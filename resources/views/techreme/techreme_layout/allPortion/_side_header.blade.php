            ...
            <ul>
                <li class="has-sub-menu"><a data-clipboard-text="fa fa-th-large" href="#"><i class="fa fa-th-large" aria-hidden="true"></i> <span>Dashboard</span></a>
                    <ul class="side-header-sub-menu">
                        <li><a data-clipboard-text="fa fa-square" href="{{route('techreme')}}"><i class="fa fa-square" aria-hidden="true"></i><span>Home</span></a></li>
                    </ul>
                </li>
                ...
                <li class="has-sub-menu"><a data-clipboard-text="fa fa-th-large" href="#"><i class="fa fa-th-large" aria-hidden="true"></i> <span>Registration</span></a>
                    <ul class="side-header-sub-menu">
                        ...
                        <li><a data-clipboard-text="fa fa-square" href="{{route('Register.client.view')}}"><i class="fa fa-square" aria-hidden="true"></i><span>Client List</span></a></li>
                    </ul>
                </li>
                ...
                <li class="has-sub-menu"><a data-clipboard-text="fa fa-th-large" href="#"><i class="fa fa-th-large" aria-hidden="true"></i> <span>Services</span></a>
                    <ul class="side-header-sub-menu">
                        <li><a data-clipboard-text="fa fa-square" href="{{route('service.view')}}"><i class="fa fa-square" aria-hidden="true"></i><span>Service List</span></a></li>
                    </ul>
                </li>
                <li class="has-sub-menu"><a data-clipboard-text="fa fa-th-large" href="#"><i class="fa fa-th-large" aria-hidden="true"></i> <span>Owner</span></a>
                    <ul class="side-header-sub-menu">
                        <li><a data-clipboard-text="fa fa-square" href="{{route('owner.view')}}"><i class="fa fa-square" aria-hidden="true"></i><span>Owner List</span></a></li>
                    </ul>
                </li>
            </ul>
        </nav>
