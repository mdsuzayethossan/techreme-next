                        ...
                        @foreach($services as $service)
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <div class="row">
                                        <a title="Edit" class="edit button button-box button-xs button-primary" href="{{ route('service.edit',$service->id) }}"><i class="zmdi zmdi-edit"></i></a>
                                        <a title="Details" class="edit button button-box button-xs button-success" href="{{ route('service.details',$service->id) }}"><i class="zmdi zmdi-more"></i></a>
