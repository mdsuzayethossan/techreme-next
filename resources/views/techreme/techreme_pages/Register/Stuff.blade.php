                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <div class="row">
                                        ...
                                        <a title="Details" class="edit button button-box button-xs button-success" href="{{ route('Register.details.stuff',$user->id) }}"><i class="zmdi zmdi-more"></i></a>
